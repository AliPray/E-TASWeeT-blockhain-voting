  ...
  async function login(){
    if (typeof window.ethereum !== "undefined"){
      ...
      try {
        ...
        //use the data fetched from the contract to set the local storage variables
         localStorage.setItem("userId",voterInfo[0]);
         localStorage.setItem("userFirstName",voterInfo[1])
         localStorage.setItem("userLastName",voterInfo[2])
         localStorage.setItem("userState",voterInfo[3])
         localStorage.setItem("vote",voterInfo[4])
  ...
  async function getCandidateInfo(){
    if (typeof window.ethereum !== "undefined"){
      ...
      try {
        ...
        console.log(array)
        localStorage.setItem("candidatesInfo",array)
